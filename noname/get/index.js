		...
		if (!info) {
			...
			for (var i = 0; i < rawName.length; i++) {
				...
				var xingList = [
					...
					"言", "福",
					// 单姓补充
					"典", "沮", "桥", "逢", "蹇", "来", "留", "祢", "牵", "麴", "审", "轲", "枣", "芈", "姒", "喜",
				];
				var xing = "";
				var ming = "";
				for (var j = 0; j < xingList.length; j++) {
					if (rawName[i].startsWith(xingList[j])) {
						xing = xingList[j];
						ming = rawName[i].slice(xing.length);
						break;
					}
				}
				if (xing == "") {
